      ...
      'conditions': [
        ['OS=="linux"', {
          ...
          'libraries': [
            ...
            '-L../vendor/mapbox-gl-native/mapnik-packaging/osx/out/build-cpp11-libstdcpp-gcc-x86_64-linux/lib/libpng16.a',
          ],
        }],
        ['OS=="mac"', {
          'include_dirs': [
          ...
          'libraries': [
            ...
            '-L../vendor/mapbox-gl-native/mapnik-packaging/osx/out/build-cpp11-libcpp-universal/lib/libpng16.a',
          ],
        }],
      ],
      'xcode_settings': {
