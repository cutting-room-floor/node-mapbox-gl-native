      ...
      'direct_dependent_settings': {
        'conditions': [
          ['OS == "mac"', {
            ...
            'link_settings': {
              'libraries': [
                '<!@(pkg-config ../vendor/mapbox-gl-native/mapnik-packaging/osx/out/build-cpp11-libstdcpp-gcc-x86_64-linux/lib/libglfw3.a --libs --static | sed s/.*-framework/-framework/g)',
